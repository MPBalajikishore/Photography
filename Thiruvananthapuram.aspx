<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Thiruvananthapuram.aspx.cs" Inherits="photography.Thiruvananthapuram" MasterPageFile="~/site1.Master"%>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <style>
        body
        {
            background-image:url(Image/tvm.jpg);
